...
{
    /// <summary>
    ///这是 LunarCore.util.HolidayUtil 的测试类，旨在
    ///包含所有 LunarCore.util.HolidayUtil 单元测试
    ///</summary>
    [TestClass()]
    public class HolidayUtilTest
    {
        ...
        public void getHolidayTest()
        {
            ...
            actual = LunarCore.util.HolidayUtil.getHoliday(year, month, day).ToString();

            Assert.AreEqual(expected, actual, "LunarCore.util.HolidayUtil.getHoliday 未返回所需的值。");
        }
        ...
        public void getHolidayTest1()
        {
            ...
            actual = LunarCore.util.HolidayUtil.getHoliday(ymd).ToString();
        ...
        public void getHolidaysTest()
        {
            ...
            actual = LunarCore.util.HolidayUtil.getHolidays(year).Count;

            Assert.AreEqual(expected, actual, "LunarCore.util.HolidayUtil.getHolidays 未返回所需的值。");
        }
        ...
        public void getHolidaysTest1()
        {
            ...
            actual = LunarCore.util.HolidayUtil.getHolidays(year, month).Count;
        ...
        public void getHolidaysTest2()
        {
            ...
            actual = LunarCore.util.HolidayUtil.getHolidays(ymd).Count;
        ...
        public void getHolidaysByTargetTest()
        {
            ...
            actual = LunarCore.util.HolidayUtil.getHolidaysByTarget(year, month, day).Count;

            Assert.AreEqual(expected, actual, "LunarCore.util.HolidayUtil.getHolidaysByTarget 未返回所需的值。");
        }
        ...
        public void getHolidaysByTargetTest1()
        {
            ...
            actual = LunarCore.util.HolidayUtil.getHolidaysByTarget(ymd).Count;
